...
$ModelProfiles = [ordered]@{
    ...
    'Qwen3.6 27B · MTP  [64k ctx]' = @{
        ...
        GpuLayers        = 117
        FlashAttn        = $true
        CacheTypeK       = 'q4_0'   # q8_0 leaves only ~1.1 GB headroom at 64K on RTX 4090
        CacheTypeV       = 'q4_0'   # q4_0 saves ~1.1 GB VRAM, negligible quality impact on KV cache
        Parallel         = 1
        Threads          = 13
        ...
        BannerLine1      = 'QWEN 3.6 27B  ·  MTP'
        BannerLine2      = 'MTP · 64k · KV:q4_0 · tk:3072 → :8080'
    }
    ...
    'Qwen3.6 27B · Q4_K_M + MTP  [64k · no thinking]' = @{
        ModelFile        = 'Qwen_Qwen3.6-27B-Q4_K_M.gguf'
        CtxSize          = 65536
        GpuLayers        = 129
        FlashAttn        = $true
...
Write-Host "  ${c}║   ╚══════╝╚══════╝╚══════╝   ╚══════╝   ╚═╝          ║${r}"
Write-Host "  ${c}║                                                      ║${r}"
Write-Host "  ${c}║              Stack Launcher  v1.068                   ║${r}"
Write-Host "  ${c}╚══════════════════════════════════════════════════════╝${r}"
Write-Host ""
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCgi0StsV2gvbCN
# l9NxOX2PwO8gswRnUKnstzEK7U8VCqCCAxgwggMUMIIB/KADAgECAhAnjvKeW2tW
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIHMbqtCEJtKLCu/sQtpOyXQ7
# NvM8QLs4Mb/srb0wx/bqMA0GCSqGSIb3DQEBAQUABIIBAFqhm2mhU23FS7CIIQui
# Btc8BdmZ6HQO8saJUgbl5QthD64EI57FwU8Ow3I53FMzXC3Tf6mOkKEVMhIPbi1X
# rGIO57lWfAaP8rM9mq1zXp25yzA6XFznCwLXkzpEkWJN26+iiCXmJ6IeNbCtrvR9
# x0gKAvwec6MZqgs/ttUI01TumVVjVL5p3vHYggZAWwlFAShFW3PR6Bkj61YbOMvo
# TAbPNjvvdMk0Xg/F0E97ZaMG4qPdbhjWph/NlSABdAdCTVEzsM/3QRKhekD9v+Nq
# j+AQquNARBL7sUfH9ea8MGTpwMvDtqv+HeIqF34/eeihexZS8cMzLsoURzlWArrt
# isk=
