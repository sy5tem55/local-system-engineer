...
Write-Host "  ${c}║   ╚══════╝╚══════╝╚══════╝   ╚══════╝   ╚═╝          ║${r}"
Write-Host "  ${c}║                                                      ║${r}"
Write-Host "  ${c}║              Stack Launcher  v1.061                   ║${r}"
Write-Host "  ${c}╚══════════════════════════════════════════════════════╝${r}"
Write-Host ""
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAvsD5BX76uQSgg
# 101uhmDPN60BdSZUfX9xTFCDitRdPKCCAxgwggMUMIIB/KADAgECAhAnjvKeW2tW
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIDQ9CFvZISEhDIocs3sxSjdL
# V1NUUUHTIafItAhKRjZXMA0GCSqGSIb3DQEBAQUABIIBAAFaSTkEDy0OyOAyhLqt
# QQDhlLUhN+kwm2tlPEEMMm83XnZXCbKcm2pSPhEmojfggp3Sxkfg1l36Pj0av1FB
# I7jxeK/6WwrvjO5gMOU2wiEcYa3H4dQEJpkAWi7TmR0hu8ihNof7QAmEP/0g8VB6
# TF+H35oA9U/5rCmA+///zb0/R6tmsTfwIXYOI4ZgTvx+6yRfm6qJIAQylk0BSwHM
# 6yGitq+ERYbGJKxWGDzutdnUDnDhokxVrvHBg/PGquIeVFQx3oP9/SS7oCNKO7RH
# lmRI/2JUHjYZDZck2vWPIk3fOux/mQBjUPrrqxaaKfx1z21PmTovikH3oU2bzvZr
# KpM=
