...
| **System Prompt (LUCIFER)** | **node4090-v0.6.3** | `prompts/v0.6.3.md` | ✅ **CANONICAL** (drift fix 2026-08-24, task 2c887b5d; prompts/ is the canonical dir, tools/system-prompt-v0.5.x superseded) — REQUEST-SHAPE MAPPINGS, ledger-first task loop, all v0.3.x tools. **Paste into llama-ui system prompt field + start fresh threads.** |
| **System Prompt (node3090)** | **v0.4.0** | `tools/system-prompt-node3090-v0.4.0.md` | ✅ deployed (2026-08-24, operator paste) — 7 live-verified drift fixes; v0.3.0 + v0.1.0 archived |
