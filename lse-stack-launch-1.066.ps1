...
Write-Host "  ${c}║   ╚══════╝╚══════╝╚══════╝   ╚══════╝   ╚═╝          ║${r}"
Write-Host "  ${c}║                                                      ║${r}"
Write-Host "  ${c}║              Stack Launcher  v1.066                   ║${r}"
Write-Host "  ${c}╚══════════════════════════════════════════════════════╝${r}"
Write-Host ""
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAXAi8QC8uozggO
# 0ZoZ5zy1xzGJHpTEezy6wDeIxlhdcaCCAxgwggMUMIIB/KADAgECAhAnjvKeW2tW
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEICHk3OT1i3328Al4b2YVYLPM
# 5XNZt8+6ztjkYVsBQ7PFMA0GCSqGSIb3DQEBAQUABIIBABoJ6a/RXGOH0x/hVEdI
# w3LCBRqjIFW/I4ufA79dZ4VROD/wFdtXRTci1d+m+ZF2bUh39cYgBAMrll27ZFyY
# A1tgPSKJNi88rQvu4VkjrtT7/l0g2Pou4XByC+hipl1s+7al5uLIV5tFOzCODlyn
# ZCWuEJC+SVbU5UM+93yOmLALYvNvgTdBhlhVuxYgEKOTxKl9o1keQ+PK8+OyPG9+
# fob/FZimlwWqByi8LqGgSQ1guIG4dT1A1EMltS1rLZ4zfPD/y5YLtRTFq41qv/8X
# AjWXC9C8/loOsKdYUC1XCI54Nr5di5kmQsHwdgsLC7NTAw4OOFSWRFqFwy1QF9V6
# 4FM=
