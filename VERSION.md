...
> Last updated: 2026-07-15 (Codex) — TRAUM production reconciliation: dream tools v0.12.0/v0.4.0/v0.3.0; Qwen 1024-dimensional KB contract
...
| MCP Gateway | **goethe_mcp v1.9.3 / launcher v2.1.3** | 2026-07-15 | ✅ deployed — `_TokenGuard` accepts `Bearer <token>` or raw token; port 9700; HTTP transport; canonical LUCIFER launcher is detached/SIGHUP-proof and verifies the bound process before writing its PID. |
