# LSE Evaluation Test Suite — v3.5
> Model: Qwen3.6-27B-Q5_K_M · Prompt: v0.5.2 · Tool: v1.5.7 · Filter: lse-routing-filter v1.1.0 + lse-context-monitor v1.2.0
...
```
Model:    Qwen3.6-27B   Quant: Q5_K_M   Prompt: v0.5.2   Tool: v1.5.7
Filter:   lse-routing-filter v1.1.0 + lse-context-monitor v1.2.0   Profile: 32k thinking
Date:
