...
description: Safe shell execution for the Local System Engineer (LSE) WSL2/Ubuntu 24.04 agent.
  ...
  pfsense_query, pfsense_log_summary, start_node_agent, stop_node_agent, and search_reddit.
...
class Tools:
    ...
    def pfsense_graphql(
        ...
        SCHEMA DISCOVERY — when unsure of field names:
          pfsense_graphql(query='{ __schema { queryType { fields { name } } } }', api_key=key)
