...
class Tools:
    ...
    def wake_node(self, node: str) -> str:
        ...
        WRITE ACCESS NOTE:
          WoL is a POST to pfSense (/api/v2/services/wake_on_lan). It sends a UDP
        ...
        wol_result = self.pfsense_query(
            endpoint="/api/v2/services/wake_on_lan",
            method="POST",
    ...
    def shutdown_node(self, node: str) -> str:
        ...
        return f"Shutdown command sent to {node} ({hostname}): {result}"
