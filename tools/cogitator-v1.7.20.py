...
class Tools:
    ...
    async def sudo_delegation_block(
        ...
        # v1.7.20: force-surface to the UI out-of-band so the block is visible even
        # if the model called this mid-<think> (where the tool-result card collapses).
        # Best-effort: an emitter failure must never break the delegation return.
