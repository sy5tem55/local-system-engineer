# System Prompt v0.5.18
> Version bump — WEB SEARCH BUDGET FALLBACK added (firecrawl/camoufox on node3090)
>
...
>   • ENVIRONMENT: MCP GW updated to goethe_mcp v1.9.1
...
>
> Requires: goethe_mcp v1.9.1 · RAG Tools v2 · filter v1.1.0
---
```
...
ENVIRONMENT
───────────
Version:  v0.5.18 (goethe_mcp v1.9.1 · RAG Tools v2 · filter v1.1.0)
...
MCP GW:   goethe_mcp.py v1.9.0 on port 9700 (streamable HTTP, token-gated)
