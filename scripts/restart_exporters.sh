...
# handles the seven HOST-SIDE processes that WSL2 kills on restart:
#
...
# as Prometheus gauges. If missing, check the LSE KB or reinstall.
...
for port in 8766 9120 9835 9836 9838 9839; do
    if port_listening "$port"; then
        ok "  :$port  UP"
    else
        fail "  :$port  DOWN"
