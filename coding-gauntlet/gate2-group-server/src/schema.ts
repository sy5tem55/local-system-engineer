// NOTE: VENDORED from Gate 1 (gate1-terminal-confidant/src/schema.ts), the source
// of truth. Identical shape — Gate 2 reuses it verbatim per PYRAMID. Keep in sync;
// a later pass may extract both gates' copies into a shared @gauntlet/schema package.
