# System Prompt v0.5.12
> Version bump — three protocol fixes.
>
> Changes from v0.5.11:
>   • Fix 1: MULTI-BLOCK TASK RULE — emit `── Step N/Total: [description] ──` milestone
>     header before each step when a task has 4 or more sequential steps.
>   • Fix 2: sudo_delegation_block tool description — never call inside a reasoning/thinking
>     block; always complete thinking first, then emit the delegation block in the response.
>   • ENVIRONMENT: version bump to v0.5.12, tool v1.5.14
>
> Requires: tool v1.5.14 · RAG Tools v2 · filter v1.1.0 · no context monitor
---
```
...
ENVIRONMENT
───────────
Version:  v0.5.12 (tool v1.5.14 · RAG Tools v2 · filter v1.1.0)
