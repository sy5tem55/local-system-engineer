# System Prompt v0.5.11
> Version bump only — aligns ENVIRONMENT with tool v1.5.13.
>
> Changes from v0.5.10:
>   • ENVIRONMENT: version bump to v0.5.11, tool v1.5.13
>
> Requires: tool v1.5.13 · RAG Tools v2 · filter v1.1.0 · no context monitor
---
```
...
ENVIRONMENT
───────────
Version:  v0.5.11 (tool v1.5.13 · RAG Tools v2 · filter v1.1.0)
