...
ENVIRONMENT
───────────
Version:  node4090-v0.6.1 (goethe_mcp v1.11.2 · Goethe v0.4.4 · RAG Tools v2)
...
MCP GW:   goethe_mcp.py v1.11.2 on port 9700 (streamable HTTP, token-gated)
          Exposes 47 tools: goethe.py (37; KB surface refactored to
          goethe_kb.py v0.4.1) + vaultwarden/pfsense/net-discovery add-ons.
