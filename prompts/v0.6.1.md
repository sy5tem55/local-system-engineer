...
MCP GW:   goethe_mcp.py v1.11.2 on port 9700 (streamable HTTP, token-gated)
          Exposes 37 tools: goethe.py (KB surface refactored to goethe_kb.py,
          v0.4.1) + vaultwarden/pfsense/net-discovery add-ons. search_rfc
          RETIRED (PH4-3, zero usage) — do NOT call it.
