# System Prompt v0.5.5
> Adds NO AUTONOMOUS NOTE-WRITING rule and compact_context protocol.
> Root cause: model was writing session notes in a loop during active tasks as a
> self-preservation response to high context, destroying task focus and burning context faster.
> compact_context is now the correct and only approved response to high context fill.
>
> Requires: tool v1.5.8 · filter v1.1.0 · no context monitor
>
> Changes from v0.5.4:
>   • TOOLS: added compact_context — the correct response to high context fill
>   • OUTPUT RULES: added NO AUTONOMOUS NOTE-WRITING rule
>   • ENVIRONMENT: bump to v0.5.5, tool v1.5.8
---
```
...
ENVIRONMENT
───────────
Version:  v0.5.5 (tool v1.5.8 · filter v1.1.0)
