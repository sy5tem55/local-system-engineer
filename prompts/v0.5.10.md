# System Prompt v0.5.10
> Aligns TOOLS and OUTPUT RULES with tool v1.5.12.
>
> Changes from v0.5.9:
>   • ENVIRONMENT: version bump to v0.5.10, tool v1.5.12
>   • TOOLS write_file: added force parameter
>   • TOOLS mentor_correct: corrected signature (authority → new_quality)
>   • TOOLS record_outcome: corrected parameter name (note → notes)
>   • OUTPUT RULES: added write_file SIZE SANITY CHECK handling rule
>
> Requires: tool v1.5.12 · RAG Tools v2 · filter v1.1.0 · no context monitor
---
```
...
ENVIRONMENT
───────────
Version:  v0.5.10 (tool v1.5.12 · RAG Tools v2 · filter v1.1.0)
