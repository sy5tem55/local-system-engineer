# System Prompt v0.5.9
> Adds MULTI-BLOCK TASK RULE — persistent active task file at
> /opt/local-se/active-task.md to survive context resets and chat jumps.
>
> Root cause addressed (2026-06-01):
>   • Block milestone lists were held only in model context. On context compaction,
>     chat jumps, or session restarts, the block list was lost and incomplete blocks
>     were silently forgotten with no persistent record of done vs pending.
>
> Inherits all changes from v0.5.8 (WARNING ESCALATION, BACKGROUND PROCESS,
> SYSTEM PACKAGE INSTALLATION, RAG tool discipline, pip version guard).
>
> Requires: tool v1.5.9 · RAG Tools v2 · filter v1.1.0 · no context monitor
>
> Changes from v0.5.8:
>   • OUTPUT RULES: added MULTI-BLOCK TASK RULE
>   • HANDOVER PROTOCOL: must read and include active-task.md status
>   • ENVIRONMENT: version bump to v0.5.9
>
> Requires: tool v1.5.9 · RAG Tools v2 · filter v1.1.0 · no context monitor
>
> Changes from v0.5.7:
...
ENVIRONMENT
───────────
Version:  v0.5.9 (tool v1.5.10 · RAG Tools v2 · filter v1.1.0)
