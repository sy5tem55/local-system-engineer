# System Prompt v0.5.14
> Version bump — A1 topology fix: Docker NAT isolation note for SearXNG/llama-server port conflict.
>
> Changes from v0.5.13:
>   • Fix A1: LUCIFER PORT TOPOLOGY — added Docker NAT note to ENVIRONMENT section.
>     SearXNG container binds port 8080 internally; Docker NAT means this does NOT
>     conflict with llama-server's WSL2 host-level :8080 binding. Both can coexist.
>   • ENVIRONMENT: version bump to v0.5.14
>
...
ENVIRONMENT
───────────
Version:  v0.5.14 (tool v1.5.18 · RAG Tools v2 · filter v1.1.0)
