// NOTE: VENDORED from Gate 1 (source of truth). Identical shape — reused verbatim per
// PYRAMID. Keep in sync; a later pass extracts a shared @gauntlet/schema package.
