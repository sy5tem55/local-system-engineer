...
- Real metrics token: `open_metrics: [REDACTED-SEARXNG-METRICS-TOKEN]` — Prometheus uses basic_auth (empty username + token as password). `metrics-admin-2025` and `searxng-metrics-token-2026` are dead/never-existed.
